...
class Xcrud_config
{
    ...
    public static $dbhost = DB_HOSTNAME; // Your database host, 'localhost' is default.
    //
    ...
    public static $db_time_zone = '+03:00'; // database time zone, if you want use system default - leave empty.
    ...
    public static $column_cut = 250; // Sets the maximum number of characters in the column.
    public static $limit = 100; // default limit of rows per page
    public static $limit_list = array( '100', '250', '500', 'all'); // default limits list
    ...
    public static $print_full_texts = true; // print grid without cutting
    ...
    public static $enable_search = true; // show search block
    ...
    // alert settings
    public static $email_from = 'info@thebridge.co.tz'; // email from address
    public static $email_from_name = 'SMART WORKSPACE'; // email from name
    ...
    public static $autoclean_timeout = 6000; // in seconds.(100min) Do not change, if not sure. Xcrud clears old instances in session when you reload browser tab or open new tab with xcrud. In this case Xcrud can't work in two tabs in the same time. You can increase timeout on your risk.
